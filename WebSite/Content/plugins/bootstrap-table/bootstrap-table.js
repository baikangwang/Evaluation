...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        iconsPrefix: 'fontawesome', // glyphicon of fa (font awesome)
        icons: {
            paginationSwitchDown: 'fa fa-caret-square-o-down icon-chevron-down',
            paginationSwitchUp: 'fa fa-caret-square-o-up icon-chevron-up',
            refresh: 'fa fa-refresh icon-refresh',
            toggle: 'fa fa-list-alt icon-list-alt',
            columns: 'fa fa-th icon-th',
            detailOpen: 'fa fa-plus icon-plus',
            detailClose: 'fa fa-minus icon-minus'
        },
