...
{
    public static string Format(string strTypeCode, string originFileName, string pathFormat)
    {
        if (String.IsNullOrWhiteSpace(strTypeCode))
        {
        ...
        pathFormat = pathFormat.Replace("{TypeCode}", strTypeCode);
