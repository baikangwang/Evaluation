<%@ Page Title="" Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="ReVoteSet.aspx.cs" Inherits="Evaluation.View.ActivityManage.ReVoteSet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ul class="navs">
        ...
        <li class="nav1" style="float:left;padding-right:5px;">           
          <a href="../ActivityManage/VotePrizeList.aspx">投票结果确认</a>
        </li>        
    </ul>
    <div class="condition">
        <span>专  业： 
    ...
    <script>
        ...
        function operateFormatter(value, row, index) {
            //if (row.VoteType == "2201"
            //    || (row.VoteType == "2202" && row.MultipleVoteRound == 2)
            //    || (row.VoteType == "2203" && row.MultipleVoteRound == 3)) {
            //    return [
            //        '<a href="javascript:void(0)" title="等票复投设定" >',
            //        '<i class="fa fa-edit" style="color:rgba(0,0,0,0.2)"></i>',
            //        '</a>  '
            //    ].join('');
            //} else {
                return [
                    '<a class="ReVoteSet" href="javascript:void(0)" title="等票复投设定">',
        ...
        function InitTable(PageSize, CuttentPage, Specialtys, PrizeType, PrizeName) {
            ...
            window.operateEvents = {
                'click .ReVoteSet': function (e, value, row, index) {
                    window.location = "VoteResult.aspx?PrizeID=" + row.PrizeID;
                }
            };
                    ...
                    if (data != "") {
                        ...
                        var option = {
                            ...
                            columns: [
                                ...
                                { field: 'VotedExpertCount', title: '已投票专家数量', align: 'center', valign: 'middle' },
