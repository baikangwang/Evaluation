<%@ Page Title="活动管理" Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Landscape.aspx.cs" Inherits="Evaluation.View.Declaration.Landscape"  validateRequest="false"%>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content" runat="server" id="divfather">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeDeclarationName" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>申报单位</td>
                                ...
                                <table class="shejidanwei">
                                    <tr>
                                        ...
                                        <td colspan="4" style="border-top: none; border-right: none;">
                                            ...
                                            <asp:CheckBox runat="server" ID="IsLandscapeDeclarationUnit" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>通讯地址</td>
                                        <td colspan="4" style="border-right: none;">
                                            ...
                                            <asp:CheckBox runat="server" ID="IsLandscapePostalAddress" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:CheckBox ID="IsLandscapeLinkman" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                                        </td>
                                        <td>电话</td>
                                        <td style="border-right: none;">
                                            <asp:TextBox ID="TelephoneNumber" runat="server" ClientIDMode="Static" Width="88.5%"></asp:TextBox>
                                            <asp:CheckBox runat="server" ID="IsLandscapeTelephoneNumber" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>手机</td>
                                        <td>
                                            ...
                                            <asp:CheckBox ID="IsLandscapeMobileNumber" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                                        </td>
                                        <td>传真</td>
                                        <td style="border-right: none;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:CheckBox ID="IsLandscapePostcode" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                                        </td>
                                        <td>电子邮箱</td>
                                        <td style="border-right: none;">
                                            <asp:TextBox ID="EmailAddress" runat="server" ClientIDMode="Static" Width="88.5%"></asp:TextBox>
                                            <asp:CheckBox runat="server" ID="IsLandscapeEmailAddress" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeDevelopmentOrganization" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>施工单位</td>
                            <td>
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeConstructionOrganization" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>建设地点</td>
                            <td>
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeConstructionLocation" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计类别</td>
                            <td>
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeDesignCategory" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计开始时间
                                    ...
                                    <tr>
                                        <td style="width: 40%">
                                            <div class="datepicker input-group date">
                                                ...
                                                <asp:CheckBox runat="server" ID="IsLandscapeDesignStartDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                        <td>设计终止时间
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                            <div class="datepicker input-group date">
                                                ...
                                                <span class="input-group-addon" style="width: 35px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                <asp:CheckBox runat="server" ID="IsLandscapeDesignEndDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="width: 40%;">
                                            <div class="datepicker input-group date">
                                                ...
                                                <span class="input-group-addon" style="width: 35px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                <asp:CheckBox runat="server" ID="IsLandscapeConstructionEndDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                        <td>验收时间　
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                            <div class="datepicker input-group date">
                                                ...
                                                <span class="input-group-addon" style="width: 35px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                <asp:CheckBox runat="server" ID="IsLandscapeAcceptanceDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="width: 40%;">
                                            <div class="datepicker input-group date">
                                                ...
                                                <span class="input-group-addon" style="width: 35px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                <asp:CheckBox runat="server" ID="IsLandscapeDeliveryDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                        <td>验收部门　
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                            ...
                                            <asp:CheckBox runat="server" ID="IsLandscapeAcceptanceDepartment" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox runat="server" ID="IsLandscapeInvestSource" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                    </table>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1302" runat="server" ClientIDMode="Static" GroupingText="技术申报内容">
                    <table>
                        <tr>
