<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LegalStates.ascx.cs" Inherits="Evaluation.View.Declaration.LegalStates" %>
 <asp:Panel ID="PanelLegalStates" runat="server" GroupingText="申报单位法人代表人声明">
        <table style="width:90%">
            <tr>
                <td colspan="4" style="font-size:16px;">申报单位法人代表人声明</td>
            </tr>
            <tr>
                <td colspan="4">
                         <div style="width:85%;height:200px;margin:30px auto 0 auto;text-align:left;line-height:35px;font-size:14px;">
                         本人 <u>　<asp:Literal ID="LegalPeopleName" runat="server" ClientIDMode="Static"></asp:Literal>　</u>&nbsp;&nbsp;&nbsp;
                       ...
                       （身份证号码）郑重声明，我单位申请参加 
                        ...
                        申报资料如有虚假，本单位将自动退出<asp:Literal runat="server" ID="litAwardName"></asp:Literal> 的评选，并愿接受主管部门所做的处理。<br />
                        附表：《申报项目次序表》。
                        </div> 
                </td>
            </tr>
