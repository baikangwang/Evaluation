...
{
    public partial class Architecture_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_06_Architecture tempArchitecture =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_06_Architecture>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_06_Architecture>(tempArchitecture, divfather);
                if (FileCatalog.Text == "")
                {
