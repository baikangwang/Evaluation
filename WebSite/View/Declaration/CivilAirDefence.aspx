<%@ Page Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="CivilAirDefence.aspx.cs" Inherits="Evaluation.View.Declaration.CivilAirDefence" validateRequest="false" %>
    ...
    <style>
       ...
       .nav-tabs {
        ...
        #Indicators_AntichemicalTextBox{
            width:86%;text-align:left;margin-left:10px;
        }
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceDeclarationUnit" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>通讯地址
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceDevelopmentOrganization" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>施工单位
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceConstructionOrganization" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>使用单位
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceUseUnit" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>建设地点
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceConstructionLocation" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计类别
                            ...
                            <td colspan="2">
                                ...
                                <asp:CheckBox runat="server" ID="IsCivilAirDefenceDesignCategory" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                            <td>设计起止时间
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="datepicker input-group date">
                                    ...
                                    <asp:CheckBox runat="server" ID="IsCivilAirDefenceConstructionStartDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                            <td>竣工时间
                            </td>
                            <td>
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" style="width: 1px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsCivilAirDefenceConstructionEndDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsCivilAirDefenceAcceptanceDepartment" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>消防备案时间
                            ...
                            <td colspan="2">
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsCivilAirDefenceFireControlRecordDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                            <td>交付使用时间
                            </td>
                            <td>
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" style="width: 1px;"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsCivilAirDefenceDeliveryDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox runat="server" ID="IsCivilAirDefenceInvestSource" ClientIDMode="Static" ToolTip="公开" Checked="true" />

                            </td>
                            <%--<td>申报等级
                            </td>--%>
                            <%--<td>
                                <asp:RadioButtonList runat="server" ID="DeclarationLevel" ClientIDMode="Static" RepeatDirection="Horizontal"></asp:RadioButtonList>
                                <asp:CheckBox runat="server" ID="IsCivilAirDefenceDeclarationLevel" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>--%>
                        </tr>
                         <tr>
                            <td>专业类别</td>
