<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Standard_V2.aspx.cs" Inherits="Evaluation.View.Declaration.Standard_V2"  validateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
       ...
       #BenefitsTextBox,#PrimaryCoverageTextBox{
            width:81%;text-align: left;margin-left:10px;
        }
    ...
    <div class="tabbable">
        ...
        <div class="tab-content" runat="server" id="divfather">
            <div class="tab-pane active" id="btab1">
                <asp:Panel ID="panelPart_1701" runat="server" ClientIDMode="Static" GroupingText="项目基本情况">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" style="text-align:left!important; padding-left:20px;">
                                申报材料目录，一式两份（不限于此）：<br />
                                <asp:TextBox ID="FileCatalog" runat="server" TextMode="MultiLine" ClientIDMode="Static" Width="96.5%" Height="200px"></asp:TextBox>
...
<%--                        <tr>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1702" runat="server" ClientIDMode="Static" GroupingText="建筑工程标准设计项目特点">
                    <table>
                        <tr>
                    ...
                    <div style="text-align: center; margin-top: 40px;">
                        ...
                        <a onclick="javascript:onPrev('03')" class="btnt up" style="margin-left: 20px;">上一步</a>
                        <a onclick="javascript:onNext('03')" class="btnt up" style="margin-left: 20px;">下一步</a>
                    </div>
                </asp:Panel>
            </div>
