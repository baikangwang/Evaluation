...
{
    public partial class IntelligentBuilding_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               // Dal.Models.TemplateInfo tempInfo = (Dal.Models.TemplateInfo)Session["TemplateInfo"];
                ...
                Dal.Models.Template_09_IntelligentBuilding tempIntelligentBuilding =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_09_IntelligentBuilding>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_09_IntelligentBuilding>(tempIntelligentBuilding, divfather);
                if (FileCatalog.Text == "")
                {
