<%@ Page Title="项目管理" Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="ArchitectureReview.aspx.cs" Inherits="Evaluation.View.Declaration.ArchitectureReview"  validateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
       function setData(data) {
           ...
           $('#StructuralFeatures').html(DecodeUEditorContent($('#StructuralFeatures').text()));
           for (var j = 1; j < 5; j++) {
