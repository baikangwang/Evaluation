<%@ Page Title="绿色建筑" Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="GreenBuilding_V2.aspx.cs" Inherits="Evaluation.View.Declaration.GreenBuilding_V2" validateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
     ...
     <%--   tbody > tr > td:nth-child(2) > div {
       ...
       #CompanyOpinionTextBox,#AssociationOpinionTextBox,#AwardTextBox{
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tabbable">
        ...
        <li><a id="tab_09" href="#btab9" data-toggle="tab">9、审核意见</a></li>
        <li><a id="tab_10" href="#btab10" data-toggle="tab">10、附件目录</a></li>
        <li><a id="tab_11" href="#btab11" data-toggle="tab">11、法人声明</a></li>
        <li><a id="tab_12" href="#btab12" data-toggle="tab">12、合作声明</a></li>
        <li><a id="tab_13" href="#btab13" data-toggle="tab" class="ExpertReviewList2" style="display:none;">13、评审意见</a></li>                           
                ...
                <asp:Panel ID="panelPart_0405" runat="server" ClientIDMode="Static" GroupingText="专业技术指标（设备专业）"  >
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="IndependentRatio" runat="server" Style="width:85%"></asp:TextBox> %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="EnergyEfficiencyIndex" runat="server" Style="width:85%"></asp:TextBox> %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="EnergyConsumptionReductionRange" runat="server" Style="width: 85%"></asp:TextBox> %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="RenewableEnergyForAirConRatio" runat="server" Style="width: 85%"></asp:TextBox> %
                ...
                <asp:Panel ID="panelPart_0406" runat="server" ClientIDMode="Static" GroupingText="专业技术指标（电气专业）"  >
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="TransformerIndex" runat="server" Style="width: 80%"></asp:TextBox> W/㎡
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="TransformerEnergyEfficiencyRating" runat="server" Style="width: 80%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td  colspan="2">
                                <asp:TextBox ID="HarmonicSource" runat="server" Style="width: 80%"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="LampName1" runat="server" Style="width: 85%"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="LampName2" runat="server" Style="width: 85%"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="LampName3" runat="server" Style="width: 85%"></asp:TextBox>
                ...
                <asp:Panel ID="panelPart_0408" runat="server" ClientIDMode="Static" GroupingText="审核意见">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Award" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%; height: 200px;"></asp:TextBox>
                                <asp:CheckBox runat="server" ID="IsGreenAwards" ClientIDMode="Static" ToolTip="公开" Checked="true" />
  ...
  <script type="text/javascript">
      ...
      function onSave(PartCode, Tip) {
          ...
          $("#Award").val(EncodeUEditorContent(UE.getEditor('AwardTextBox').getContent()));                                       // 曾获奖项
          ...
          if (!checkUEditor('ProjectOverviewTextBox')
                ...
                || !checkUEditor('CompanyOpinionTextBox')
                || !checkUEditor('AssociationOpinionTextBox')
                ) {
              return false;
          }
          var result = [];
      ...
      $(function () {
          ...
          InitUEditor('ArchitectureMainFeaturesTextBox', 1000);  // 建筑专业设计主要特点
          InitUEditor('StructureMainFeaturesTextBox', 1000);     // 结构专业设计主要特点
          InitUEditor('MechanicalMainFeaturesTextBox', 2000);   // 设备专业设计主要特点
          InitUEditor('ElectricalMainFeaturesTextBox', 1000);   // 电气专业设计主要特点
          InitUEditor('EconomicsFeaturesTextBox', 500);        // 经济专业主要特点
          InitUEditor('AwardTextBox', 1000);                   // 曾获奖项
          InitUEditor('CompanyOpinionTextBox', 1000);           // 申报单位意见
          InitUEditor('AssociationOpinionTextBox', 1000);       // 地方、部门勘察设计同业协会
