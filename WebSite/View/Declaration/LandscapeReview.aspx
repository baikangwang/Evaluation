<%@ Page Title="" Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="LandscapeReview.aspx.cs" Inherits="Evaluation.View.Declaration.LandscapeReview" validateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Content/Javascript/DeclarationReview.js"></script>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content"  id="divfather">
            <div class="tab-pane active" id="btab1">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1301"   GroupingText="项目基本情况">
                    <table>
                        <tr>
                            <td style="width: 150px;">项目名称</td>
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static" ID="DeclarationName"   Width="95.5%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDeclarationName"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>申报单位</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" style="border-top: none; border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="DeclarationUnit"   Width="94.8%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDeclarationUnit"  ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>通讯地址</td>
                                        <td colspan="4" style="border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="PostalAddress"   Width="94.8%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapePostalAddress"  ToolTip="公开" Checked="true" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="Linkman"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none" ID="IsLandscapeLinkman"  Checked="true"  ToolTip="公开" />
                                        </td>
                                        <td>电话</td>
                                        <td style="border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="TelephoneNumber"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeTelephoneNumber"  ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>手机</td>
                                        <td>
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="MobileNumber"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none" ID="IsLandscapeMobileNumber"  Checked="true"  ToolTip="公开" />
                                        </td>
                                        <td>传真</td>
                                        <td style="border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="FaxNumber"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none" ID="IsMunicipalFaxNumber"  Checked="true"  ToolTip="公开" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>邮政编码</td>
                                        <td>
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="Postcode"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none" ID="IsLandscapePostcode"  Checked="true"  ToolTip="公开" />
                                        </td>
                                        <td>电子邮箱</td>
                                        <td style="border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static" ID="EmailAddress"   Width="88.5%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeEmailAddress"  ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static" ID="DevelopmentOrganization"   Width="95.5%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDevelopmentOrganization"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>施工单位</td>
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static" ID="ConstructionOrganization"   Width="95.5%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeConstructionOrganization"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>建设地点</td>
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static" ID="ConstructionLocation"  Width="95.5%" ></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeConstructionLocation"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计类别</td>
                            <td>
                                ...
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDesignCategory"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计开始时间
                                        ...
                                        <td style="width: 40%; border-right: none;">
                                            <div>
                                               <asp:Label  runat="server"  ClientIDMode="Static" ID="DesignEndDate" ></asp:Label>
                                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDesignEndDate"  ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="width: 40%;">
                                            <div >
                                               <asp:Label  runat="server"  ClientIDMode="Static" ID="DeliveryDate"></asp:Label>
                                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeDeliveryDate"  ToolTip="公开" Checked="true" />
                                            </div>
                                        </td>
                                        <td>验收部门　
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                           <asp:Label  runat="server"  ClientIDMode="Static"  ID="AcceptanceDepartment"  Width="65%"></asp:Label>
                                            <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeAcceptanceDepartment"  ToolTip="公开" Checked="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeInvestSource"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                    </table>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1302"   GroupingText="技术申报内容">
                    <table>
                        <tr>
                            <td style="padding:10px;width:20%;">专业类别
                            </td>
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static"  ID="ProfessionalCategories"  Width="97%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeProfessionalCategories"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>工程规模
                            ...
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static"  ID="ProjectScale"  Width="97%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none" ID="IsLandscapeProjectScale"  Checked="true"  ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计技术及创<br />
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static"  ID="Estimate"  Width="97%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeEstimate"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>竣工结算
                            ...
                            <td>
                               <asp:Label  runat="server"  ClientIDMode="Static"  ID="Settlement"  Width="97%"></asp:Label>
                                <asp:CheckBox  runat="server"  ClientIDMode="Static"  style="display:none"  ID="IsLandscapeSettlement"  ToolTip="公开" Checked="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>决算与概算的出入原因
            ...
            <div class="tab-pane" id="btab4">
                <uc:Appendix  ID="AppendixReview" runat="server"></uc:Appendix>
            </div>
            <div class="tab-pane" id="btab5">
                <uc:LegalStates  ID="ucLegalStatesReview"  runat="server"></uc:LegalStates>
            </div>
            <div class="tab-pane" id="btab6">
                <uc:Certificate  ID="ucCertificateReview"  runat="server"></uc:Certificate>
            </div>
            <div class="tab-pane" id="btab7">
                <uc:Comments  ID="ucComments"  runat="server"></uc:Comments>
            </div>
        </div>
    </div>            
