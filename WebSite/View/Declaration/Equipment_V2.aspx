<%@ Page  Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Equipment_V2.aspx.cs" Inherits="Evaluation.View.Declaration.Equipment_V2" validateRequest="false" %>
    ...
    <style>
       ...
       .nav-tabs {
        ...
        #AcceptanceDepartment{
            float:none!important; margin-left:5px;
        }
        ...
        #AwardsTextBox,#UnitOpinionTextBox,#RecommendOpinionTextBox{
            text-align:left;margin-left:10px;width:85%;
        }
    </style>
</asp:Content>
...
<%--                    <table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="HeatingConstructionArea" runat="server" Style="width: 78%"></asp:TextBox> ㎡
                            </td>
                            <td rowspan="2">
                                采暖热负荷指标
                            </td>
                            <td>
                                <asp:TextBox ID="SpaceHeatingLoadIndicators_ALL" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(总建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="SpaceHeatingLoadIndicators" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(采暖建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="AirConBuildingArea" runat="server" Style="width: 78%"></asp:TextBox> ㎡
                            </td>
                            <td rowspan="2">
                                空调冷指标
                            </td>
                            <td>
                                <asp:TextBox ID="AirConCoolingIndicators_TotalArea" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(总建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="AirConCoolingLoad" runat="server" Style="width: 78%"></asp:TextBox> kW
                            </td>
                            <td>
                                <asp:TextBox ID="AirConCoolingIndicators_AirConArea" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(空调建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="AirConditioning" runat="server" Style="width: 78%"></asp:TextBox> kW
                            </td>
                            <td rowspan="2">
                                空调热指标
                            </td>
                            <td>
                                <asp:TextBox ID="AirConHeatingIndicators_TotalArea" runat="server" Style="width: 60%"></asp:TextBox>  W/㎡(总建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="AirConditioningHeat" runat="server" Style="width: 78%"></asp:TextBox> kW 
                            </td>
                            <td>
                                <asp:TextBox ID="AirConHeatingIndicators_AirConArea" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(空调建筑面积)
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="TotalInstalledCapacity" runat="server" Style="width: 78%"></asp:TextBox> kW
                            </td>
                            <td>
                               装机电容量指标
                            </td>
                            <td>
                                <asp:TextBox ID="InstalledElectromechanical" runat="server" Style="width: 60%"></asp:TextBox> W/㎡(总建筑面积)
                            </td> 
                        </tr>
                    </table> 
                    <br />
