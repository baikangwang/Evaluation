<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LegalStatesReview.ascx.cs" Inherits="Evaluation.View.Declaration.LegalStatesReview" %>
 <asp:Panel ID="PanelLegalStates">
        ...
        <table style="width:90%">
            ...
            <tr>
               <td colspan="4">
                         ...
                         本人 <u ID="LegalPeopleName"></u>&nbsp;&nbsp;&nbsp;
                              <u ID="LegalPeopleNumber"></u>
                       （身份证号码）郑重声明，我单位申请参加 <u ID="PrizeName5"></u>
