...
{
    public partial class Electrical_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_07_Electrical tempElectrical =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_07_Electrical>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_07_Electrical>(tempElectrical, divfather);
