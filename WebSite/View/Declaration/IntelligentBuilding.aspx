<%@ Page  Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="IntelligentBuilding.aspx.cs" Inherits="Evaluation.View.Declaration.IntelligentBuilding" validateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Content/plugins/ui-choose/src/ui-choose.js"></script>f
    <style>
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentDeclarationName" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>立项名称
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentApprovalName" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <asp:CheckBox ID="IsIntelligentDeclarationUnit" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>通讯地址
                            ...
                            <td colspan="3">
                                ...
                                <asp:CheckBox ID="IsIntelligentPostalAddress" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>联 系 人
                            ...
                            <td style="width: 30%">
                                ...
                                <asp:CheckBox ID="IsIntelligentLinkman" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>手    机
                            </td>
                            <td>
                                <asp:TextBox ID="MobileNumber" runat="server" ClientIDMode="Static" Width="87%"></asp:TextBox>
                                <asp:CheckBox ID="IsIntelligentMobileNumber" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>电    话
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentTelephoneNumber" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>邮政编码
                            </td>
                            <td>
                                <asp:TextBox ID="Postcode" runat="server" ClientIDMode="Static" Width="87%"></asp:TextBox>
                                <asp:CheckBox ID="IsIntelligentPostcode" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>传    真
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentFaxNumber" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>电子邮箱
                            </td>
                            <td>
                                <asp:TextBox ID="EmailAddress" runat="server" ClientIDMode="Static" Width="87%"></asp:TextBox>
                                <asp:CheckBox ID="IsIntelligentEmailAddress" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>境内、外合作设计单位</td>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentDevelopmentOrganization" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>施工单位
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentConstructionOrganization" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>使用单位
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentUseUnit" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>建设地点
                            ...
                            <td colspan="4">
                                ...
                                <asp:CheckBox ID="IsIntelligentConstructionLocation" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentUseProperty_Overground" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td style="width: 120px;">用地性质
                            </td>
                            <td>
                                <asp:TextBox ID="LandNature" runat="server" ClientIDMode="Static" Width="87%"></asp:TextBox>
                                <asp:CheckBox ID="IsIntelligentLandNature" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>地下
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentUseProperty_Underground" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>设计使用年限
                            </td>
                            <td>
                                <asp:TextBox ID="DesignServiceLife" runat="server" ClientIDMode="Static" style="width:81%;margin-left:4%;"></asp:TextBox> 年
                        <asp:CheckBox ID="IsIntelligentDesignServiceLife" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>总建筑面积
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="OverallFloorage" runat="server" ClientIDMode="Static" Width="85%"></asp:TextBox> m<sup>2</sup>
                               
                                <asp:CheckBox ID="IsIntelligentOverallFloorage" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentTotalLandArea" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>建筑高度
                        ...
                        <asp:CheckBox ID="IsIntelligentBuildingHeight" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentLayerCount" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>设计类别
                            ...
                            <td colspan="2">
                                ...
                                <asp:CheckBox runat="server" ID="IsIntelligentDesignCategory" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                            </td>
                            <td>设计起止时间
                            </td>
                            <td style="margin-left:2.5%;">
                                ...
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentDesignEndDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentConstructionStartDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                            <td>竣工时间
                            </td>
                            <td>
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentConstructionEndDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentAcceptanceDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                            <td>竣工验收部门
                            </td>
                            <td>
                                ...
                                <asp:CheckBox ID="IsIntelligentAcceptanceDepartment" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                        </tr>
                        <tr>
                            <td>消防备案时间
                            ...
                            <td colspan="2">
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentFireControlRecordDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                            <td>交付使用时间
                            </td>
                            <td>
                                <div class="datepicker input-group date">
                                    ...
                                    <span class="input-group-addon" ><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <asp:CheckBox runat="server" ID="IsIntelligentDeliveryDate" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_0902" runat="server" ClientIDMode="Static" GroupingText="技术申报内容">
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                <p style="text-align:left;padding-left:10px;">（项目总体介绍、项目规模、影响程度等，限500字）</p>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <p style="text-align:left;padding-left:10px;">（技术特点、先进性与创新性，主要的技术指标,采用节能技术与效果,限1500字）</p>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <p style="text-align:left;padding-left:10px;">（项目产生的经济、社会、环境效益，限500字）</p>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="PDS_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>                              
                            </td>
                            <td>
                                <asp:TextBox ID="PDS_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>                               
                            </td>
                        </tr>
                        <tr>
                            <td>通信网络系统
                            ...
                            <td>
                                <asp:TextBox ID="Network_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox> 
                            </td>
                            <td>
                                <asp:TextBox ID="Network_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>建筑设备监控系统
                            ...
                            <td>
                                <asp:TextBox ID="Monitoring_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>

                            </td>
                            <td>
                                <asp:TextBox ID="Monitoring_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Alarm_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>                                 
                            </td>  
                            <td>
                                <asp:TextBox ID="Alarm_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>                              
                            </td>
                        </tr>
                        <tr>
                            <td>安全防范系统
                            ...
                            <td>
                                <asp:TextBox ID="Security_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                               
                            </td>
                            <td>
                                <asp:TextBox ID="Security_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Meeting_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                               
                            </td>
                            <td>
                                <asp:TextBox ID="Meeting_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Radio_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                                
                            </td>
                            <td>
                                <asp:TextBox ID="Radio_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Integration_Scale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="Integration_Feature" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 95%;height: 150px;display:block;"></asp:TextBox>
