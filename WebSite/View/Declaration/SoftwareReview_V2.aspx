<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="SoftwareReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.SoftwareReview_V2"  validateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <tr>
                            ...
                            <td>
                                ...
                                <script id="PurposeTextBox" class ="review purpose" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <script id="MainFunctionsTextBox" class ="review soft" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <script id="ComparisonTextBox" class ="review soft" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <script id="BenefitsTextBox" class ="review soft" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <script id="AwardsTextBox"class="review opinion" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="1">申报单位<br />
                                意   见
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="Opinion" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 97%; height: 300px;"></asp:TextBox>
                               <script id="OpinionTextBox" class="review opinion" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="1">
    ...
    <script type="text/javascript">
        ...
        //            console.log("Workplace==" + Workplace + "ParticipantName" + ParticipantName + "AcademicTitle==" + AcademicTitle + "Speciality==" + Speciality + "Duties==" + Duties + "IDTypeName==" + IDTypeName + "IDNumber==" + IDNumber)
        //            var item = "<tr>" +
        //                "<td>" + index + "</td>" +
