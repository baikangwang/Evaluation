...
{
    public partial class Equipment_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               // Dal.Models.TemplateInfo tempInfo = (Dal.Models.TemplateInfo)Session["TemplateInfo"];
                ...
                Dal.Models.Template_08_Equipment tempEquipment =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_08_Equipment>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_08_Equipment>(tempEquipment, divfather);
