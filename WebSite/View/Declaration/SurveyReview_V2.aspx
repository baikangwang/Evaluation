<%@ Page Title="" Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="SurveyReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.SurveyReview_V2" %>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content"  id="divfather">
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1402"   GroupingText="申报项目成果概要">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <script id="TechnicalFeatureTextBox"class="review" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                       <%-- <tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <script id="AwardTextBox"  class="review" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                            <td>申报单位<br />意   见
