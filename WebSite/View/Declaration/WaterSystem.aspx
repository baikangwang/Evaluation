<%@ Page Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="WaterSystem.aspx.cs" Inherits="Evaluation.View.Declaration.WaterSystem"  validateRequest="false"%>
    ...
    <script type="text/javascript">
        ...
        function onSave(PartCode, Tip) {
           ...
           if (!checkUEditor('ProjectOverviewTextBox')
            ...
            $.ajax({
                ...
                success: function (data, status) {
                    if (data == "success" && Tip == 'Save') {
                        ...
                        //    $('textarea#FirstComment1').attr('disabled', 'true').css({ 'background': '#eee' });
                        //    $('<span><i class="fa fa-edit" aria-hidden="true" title="修改" style="font-size:22px;"></i></span>').css({ 'position': 'absolute', 'right': '60px', 'bottom': '50px', 'padding': '4px 24px' }).appendTo('#tbReview');
                        //    $('#tbReview').on('click', '.fa', function () {
                        //        $('textarea#FirstComment1').attr('disabled', false).css({ 'background': '#fff' });
                        //        $(this).remove();
                        //    })
                        //})
                    }
            ...
            //            }
            //            else {
            //                $("#txtCooperationUnit2,#txtUndertakeWork2").val("");                         
            //            }
            //            if (data[1]) {
            ...
            //            }
            //            else {
            //                $("#txtCooperationUnit3,txtUndertakeWork3").val("");
            //            }
            //            if (data[3]) {
