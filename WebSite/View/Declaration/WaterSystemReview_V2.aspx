<%@ Page Title="" Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="WaterSystemReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.WaterSystemReview_V2" ValidateRequest="false" %>
        ...
        <div class="tab-content" id="divfather">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="ProjectOverviewTextBox" class ="review sign" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="TechnicalFeaturesTextBox" class ="review sign" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="TechnicalEffectivenessTextBox" class ="review" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab-pane" id="btab4">
                <asp:Panel runat="server" ClientIDMode="Static" ID="panelPart_1803" GroupingText="水系统工程项目建设内容">
                    <table>
                        <tr>
                            <td style="width:33%;">系统类别或分项内容
                            </td>
                            <td style="width:33%;">形式及设置范围
                            </td>
                            <td style="width:33%;">特 点
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown1" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope1" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics1" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown2" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope2" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics2" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown3" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope3" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics3" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown4" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope4" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics4" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown5" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope5" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics5" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown6" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope6" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics6" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown7" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope7" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics7" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown8" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope8" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics8" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown9" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope9" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics9" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown10" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope10" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics10" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown11" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope11" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics11" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown12" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope12" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics12" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="SystemBreakdown13" Style="width: 98%; height: 100px; "></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="FormAndScope13" Style="width: 98%; height: 100px"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ClientIDMode="Static" ID="ConstructionCharacteristics13" Style="width: 98%; height: 100px;"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align: center; margin-top: 40px;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="DeclarationUnitOpinionTextBox" class ="review" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="RecommendationTextBox" class ="review sign" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align: center; margin-top: 40px;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <script id="UsingUnitFeedbackTextBox" class ="review sign" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align: center; margin-top: 40px;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <script id="ConstructionUnitFeedbackTextBox" class ="review" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align: center; margin-top: 40px;">
