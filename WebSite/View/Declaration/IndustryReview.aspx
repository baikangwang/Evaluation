<%@ Page  Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="IndustryReview.aspx.cs" Inherits="Evaluation.View.Declaration.IndustryReview" validateRequest="false" %>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content"  id="divfather">
            <div class="tab-pane active" id="btab1">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1501"   GroupingText="项目基本情况">
                    <table>
                        <tr>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1502"   GroupingText="技术申报内容（工业工程）">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align:center;padding-left:10px;">设计主要特点及社会、经济效益（限500字以内）</td>
                        </tr>
                        <tr>
                            <td colspan="2">
