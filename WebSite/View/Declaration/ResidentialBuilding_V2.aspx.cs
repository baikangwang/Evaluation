...
{
    public partial class ResidentialBuilding_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_02_ResidentialBuilding tempResidentialBuilding =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_02_ResidentialBuilding>(tempInfo.DeclarationID.Value, conn);
                ...
                //SetDropDownList(IsConsiderCoupling, BLL.SysConstant.GetConstantList("29", conn));
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_02_ResidentialBuilding>(tempResidentialBuilding, divfather);
                if (FileCatalog.Text == "")
                {
        ...
        public void SetDropDownList(DropDownList drop, List<Dal.Models.SysConstant> lst)
        {
            if (drop.ClientID == "DesignCategory")
            {
                ...
                drop.Items.Remove(drop.Items.FindByValue("1405"));
            }
            else
            {
                drop.DataSource = lst;
