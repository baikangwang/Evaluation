<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Software.aspx.cs" Inherits="Evaluation.View.Declaration.Software" validateRequest="false"%>
                ...
                <asp:Panel ID="panelPart_1601" runat="server" ClientIDMode="Static" GroupingText="项目基本情况">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="EvaluationCompany" runat="server" ClientIDMode="Static" Width="93%" class="textmargin"></asp:TextBox>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1602" runat="server" ClientIDMode="Static" GroupingText="工程勘察设计计算机软件项目特点">
                    <table>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: left; padding-left: 10px;">该软件与当前国内外同类软件的综合比较（包括存在问题及改进措施,限1500字）</td>
                        </tr>
                        <tr>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                               ...
                               <script id="OpinionTextBox" type="text/plain" style="height: 300px;"></script>
                                <asp:CheckBox runat="server" ID="IsSoftwareOpinion" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                <div class="datepicker input-group date">
                                    <asp:TextBox ID="CompanyOpinionDate" class="form-control" runat="server" ClientIDMode="Static" placeholder="请选择填写日期"></asp:TextBox>
