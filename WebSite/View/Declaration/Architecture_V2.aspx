<%@ Page Title="项目管理" Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Architecture_V2.aspx.cs" Inherits="Evaluation.View.Declaration.Architecture_V2" validateRequest="false"%>
...
<%--                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="AcceptanceDepartment" runat="server" ClientIDMode="Static" Width="96%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Qualification" runat="server" ClientIDMode="Static" Width="90%"></asp:TextBox>
                            </td>
                            <td>
                                证书编号
                            </td>
                            <td>
                                <asp:TextBox ID="CertificateNumber" runat="server" ClientIDMode="Static" Width="90%"></asp:TextBox>
                            </td>  
                        </tr>
                         <tr>
                            <td>联 系 人
...
<%--                        <tr>
                ...
                <asp:Panel ID="panelPart_0602" runat="server" ClientIDMode="Static" GroupingText="技术申报内容">
                    <table>
                        <tr>
                            ...
                            <td >
                                <asp:TextBox ID="SeismicFortificationIntensity" runat="server" Width="87%"></asp:TextBox> 度
                        ...
                        <tr>
                            ...
                            <td>设计基本地震加速度值</td>
                            <td>
                                <asp:TextBox ID="BasicSeismicAcceleration" runat="server" Width="87%"></asp:TextBox> &nbsp;g
                        ...
                        <tr>
                            ...
                            <td>场地类别</td>
                            <td>
                                <asp:TextBox ID="ConstructionSiteSoilType" runat="server" Width="87%"></asp:TextBox> 类
                            ...
                            <td style="padding: 0;">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="border-right: none;">
                                            <asp:TextBox ID="PerSqM_SteelAmount_rebar" runat="server" Width="71%"></asp:TextBox> kg/㎡
                            ...
                            <td style="padding: 0;">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="border-right: none;">
                                            <asp:TextBox ID="PerSqM_SteelAmount_SectionSteel" runat="server" Width="71%"></asp:TextBox> kg/㎡
                        ...
                        <tr>
                            <td rowspan="3" style="width: 50px;">不考虑扭转耦联
                            </td>
                       ...
                       <asp:CheckBox ID="IsAntiSeismicNoCoupling_V_Fek_kN" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Coupling_T3" runat="server" ClientIDMode="Static" Width="72%"></asp:TextBox>
                                <asp:CheckBox ID="IsAntiSeismicCoupling_T3" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>
                                <asp:TextBox ID="Coupling_Corner3" runat="server" ClientIDMode="Static" Width="72%"></asp:TextBox>
                                <asp:CheckBox ID="IsAntiSeismicCoupling_Corner3" runat="server" Checked="true" ClientIDMode="Static" ToolTip="公开" />
                            </td>
                            <td>
                                <asp:TextBox ID="Coupling_TorsionCoefficient3" runat="server" ClientIDMode="Static" Width="72%"></asp:TextBox>
  ...
  <script type="text/javascript">
      ...
      $(function () {
          ...
          notBackspace();
          // 富文本框
          InitUEditor('StructuralFeaturesTextBox',1000);              // 建筑专业设计主要特点
