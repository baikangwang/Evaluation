...
{
    public partial class TraditionalBuilding : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_03_TraditionalBuilding tempTraditionalBuilding =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_03_TraditionalBuilding>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_03_TraditionalBuilding>(tempTraditionalBuilding, divfather);
        ...
        public void SetDropDownList(DropDownList drop, List<Dal.Models.SysConstant> lst)
        {
            if (drop.ClientID == "DesignCategory")
            {
                ...
                drop.DataBind();
                drop.Items.Remove(drop.Items.FindByValue("1401"));
