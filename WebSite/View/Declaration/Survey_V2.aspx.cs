...
{
    public partial class Survey_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_14_Survey tempSurvey =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_14_Survey>(tempInfo.DeclarationID.Value, conn);
                ...
                SetDropDownList(TechnicalEconomicIndicators, BLL.SysConstant.GetConstantList("32", conn));
                ...
                List<Dal.Models.SysConstant> lstCollaborativePhase = BLL.SysConstant.GetConstantList("21", conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_14_Survey>(tempSurvey, divfather);
