<%@ Page Title="绿色建筑" Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="GreenBuildingReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.GreenBuildingReview_V2" validateRequest="false" %>
        ...
        <div class="tab-content"  id="divfather">
            <div class="tab-pane active" id="btab1">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0401"   GroupingText="全国优秀工程勘察设计行业奖申报表">
                    <table>
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:TextBox  runat="server"  ClientIDMode="Static" ID="Awards"   TextMode="MultiLine" Style="width:0; height: 0;display:block"></asp:TextBox>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0402"   GroupingText="工程勘察设计项目特点">
                    <table style="height: 500px;">
                        ...
                        <tr>
                            <td>
                                <p>（项目主要绿色设计策略和技术措施，介绍项目的总体绿色设计目标和策略，
                                    并分别从节地与室外环境、节能与能源利用、节水与水资源利用、节材与材料资源利用、室外环境质量、运行管理等方面进行阐述，限1500字）</p>
                                ...
                                <script id="KeyTechnologyTextBox" class="review"  type="text/plain" style=" height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                            <td>技术成效与深度                                                     
                        ...
                        <tr>
                            <td>
                                <p>（解决的关键技术难题，包括：被动式和主动式技术策略整合的成效与深度；绿色策略与技术和当地气候、社会、经济技术条件的适宜性、技术集成性和创新性；
                                    设计中建筑艺术与绿色策略与技术的有机结合等，对于有示范性的项目还包括达到示范性低碳、节能、环保指标的技术路线等，限1500字）</p>
                                ...
                                <script id="EffectTextBox" class="review"  type="text/plain" style=" height: 300px;"></script>
                            </td>
                        </tr>
                        <tr>
                            <td>综合效益
                        ...
                        <tr>
                            <td>
                                ...
                                <script id="BenefitTextBox" class="review"  type="text/plain" style=" height: 300px;"></script>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align:center;margin-top:40px;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <script id="ArchitectureMainFeaturesTextBox" class="review" type="text/plain" style=" height: 300px;"></script>
                            </td>
                        </tr>
                    </table>
                    <div style="text-align:center;margin-top:40px;">
                ...
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0404"   GroupingText="专业技术指标（结构专业）"  >
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SeismicFortificationCategory"  style="width:90%;display:inline-block;"></asp:Label> 类
                            </td>
                            <td>设计基本地震加速度值</td>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="EarthquakeGrouping"  style="width:90%;display:inline-block;"></asp:Label> 组
                            </td>
                            <td>场 地 类 别</td>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ConcreteAmount"  style="width:90%;display:inline-block;"></asp:Label> m³
                            </td>
                            <td>每平方米混凝土折算厚度</td>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:Label runat="server" ClientIDMode="Static" ID="SteelAmount_rebar" Width="86%"></asp:Label>
                                t
                            </td>
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PerSqM_SteelAmount_rebar"  Width="82.5%"></asp:Label> kg/㎡
                                t
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SteelAmount_SectionSteel"  Width="86%"></asp:Label> t                               
                            </td>                
                           <td colspan="1">型钢           
                            </td>
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PerSqM_SteelAmount_SectionSteel"  Width="82.5%"></asp:Label> kg/㎡
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="13">抗<br />
                            ...
                            <td colspan="10" style="padding: 0;">
                                <table style="width: 100%; height: 100%;">
                                    <tr>
                                        <td style="width: 130px">程序名称           
                                        </td>
                                        <td style="border-right: none">
                                            <asp:Label  runat="server"  ClientIDMode="Static" ID="SeismicAnalysisProgramName"  Width="97%"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0405"   GroupingText="专业技术指标（设备专业）"  >
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>采暖/空调总热负荷
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SpaceHeatingLoad"  Width="83%"></asp:Label> kW

                            </td>
                            <td style="width:150px;">空调总冷负荷
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConCoolingLoad"  Width="84%"></asp:Label> kW
                            </td>
                        </tr>
                        <tr>
                            <td>空调通风方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConVentilationMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>空调水系统方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConWaterSystemMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>给水系统方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="WaterSupplySystemMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>中水回收使用方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ReclaimedWaterRecycling"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>雨、污水排放方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SewageDischargeMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>消防给水方式
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="FireWaterSupplyMode"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IndependentRatio"  Width="92%"></asp:Label> %
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="EnergyEfficiencyIndex"  Width="92%"></asp:Label> %
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="EnergyConsumptionReductionRange"  Width="92%"></asp:Label> %
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="RenewableEnergyForAirConRatio"  Width="92%"></asp:Label> %
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsUsingStorageSystem"  Width="92%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsUsingStorageSystem"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsUsingWasteHeat"  Width="92%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsUsingWasteHeat"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsStandard"  Width="92%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsStandard"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ConsumptionRatio" Width="90%"></asp:Label> %
                                <br />
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LowerThanStandardValueRatio" Width="90%"></asp:Label> %
                            </td>
                        </tr>
                        <tr>
                            <td>场地年径流总量控制率
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="RunoffControlRate"  Width="88%"></asp:Label> %

                            </td>
                            <td>非传统水源利用率
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="NonTraditionalWaterUseRatio"  Width="90%"></asp:Label> %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="DailyWaterConsumption"  Width="88%"></asp:Label> /d

                            </td>
                            <td>用水点供水压力
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="WaterSupplyPressure"  Width="83%"></asp:Label> MPa
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="WaterEfficiencyRatingForSanitary"  Width="88%"></asp:Label> 级
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsClassifyMeterage"  Width="90%"></asp:Label></div> 
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsClassifyMeterage"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="GreeningIrrigationSystemType"  Width="88%"></asp:Label>
                            </td>
                            <td>由可再生能源提供的生<br />
                                活用热水比例
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="RenewableEnergyForLivingHotWater" Width="88%"></asp:Label> %
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="WaterSavingTechnology"  Width="97%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                ...
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0406"   GroupingText="专业技术指标（电气专业）"  >
                    <table>
                        <tr>
                            ...
                            <td  colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PowerTotalElectricLoad"  Width="85%"></asp:Label> kW

                            </td>
                            <td>照明总电负荷
                            </td>
                            <td style="width:230px;">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LightingTotalElectricLoad" Width="88%"></asp:Label>
                                kW
                        ...
                        <tr>
                            ...
                            <td rowspan="2" colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="DesignOfPowerSupply"  Width="95%"></asp:Label>
                            </td>
                            <td>变压器装机台数
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="TransformerInstalledNumber"  Width="80%"></asp:Label> 台
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="TransformerInstalledCapacity"  Width="80%"></asp:Label>
                                kVA
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PowerLoadLevel"  Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>变压器装置指标
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="TransformerIndex"  Width="75%"></asp:Label> W/㎡

                            </td>
                            <td colspan="2">低压供电半径
                            </td>
                            <td>不大于 <asp:Label  runat="server"  ClientIDMode="Static" ID="LowVoltagePowerSupplyRadius"  Width="65%"></asp:Label> m                      
                            </td>
                        </tr>
                        <tr>
                            <td>三相配电变压器能效等级
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="TransformerEnergyEfficiencyRating"  Width="75%"></asp:Label>
                                级能效
                            </td>
                            <td colspan="2">电源侧功率因数
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PowerFactor"  Width="86%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>主要谐波源
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HarmonicSource"  Width="75%"></asp:Label>
                            </td>
                            <td colspan="2">谐波治理措施
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HarmonicControl"  Width="86%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>照明方式节能措施
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="EnergySavingMeasures"  Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsAllAreasReachCurrentValue"  Width="87%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsAllAreasReachCurrentValue"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsMainRoomAchieveTargetValue"  Width="87%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsMainRoomAchieveTargetValue"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsAllAreasAchieveTargetValue"  Width="87%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsAllAreasAchieveTargetValue"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td rowspan="2">
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsColorRenderingIndexUpToStandard"  Width="87%"></asp:Label></div>
                                <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsColorRenderingIndexUpToStandard"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampName1" Width="90%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampEfficiency1"  Width="80%"></asp:Label> %

                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampName2"  Width="90%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampEfficiency2"  Width="80%"></asp:Label> %
                            ...
                            <td rowspan="2">
                                <div class="DeclarationList">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IsGlareValueUpToStandard"  Width="87%"></asp:Label></div>
                                 <div class="ExpertReviewList" style="display: none">
                                    <asp:Label  runat="server"  ClientIDMode="Static" ID="txtIsGlareValueUpToStandard"   Width="88%"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampName3"  Width="90%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LampEfficiency3"  Width="80%"></asp:Label>
                                %
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="DynamicContent"  Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>采用独立分项计量
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IndependentComponentMeasurement"  Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>弱电设计内容
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="WeakDesignContent"   Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>室内空气质量监控系统方式
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="IndoorAirQualityMonitoringSystem"   Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>由可再生能源提供的电量比例
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="RenewableEnergySourcesRatio"  Width="96.5%"></asp:Label> %
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="LightningProtectionClass"   Width="96.5%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab-pane" id="btab8">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0407"   GroupingText="专业技术指标（技术经济指标）"  >
                    <table>
                        <tr>
                            <td style="width:180px;">单位规模建筑面积指标
                            </td>
                            <td style="padding: 0;">
                                <table style="width: 100%; height: 100%;">
                                    <tr>
                                        <td style="width: 75%; border-right: none;">
                                            <asp:Label  runat="server"  ClientIDMode="Static" ID="UnitAreaIndicators"  Width="98%"></asp:Label>
                                        </td>
                                        <td style="border-right: none">㎡/                                            
                                        </td>
                                        <td style="border-right: none">
                                            <asp:Label  runat="server"  ClientIDMode="Static" ID="UnitAreaIndicatorsUnit"  Width="75%"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:180px;">使用面积系数
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="UseAreaCoefficient"  Width="97%"></asp:Label>  %
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="UnitAreaEnergyConsumption"  Width="77%"></asp:Label> kWh/㎡a
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PerYearWaterSaving"  Width="77%"></asp:Label>&nbsp;    t
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PerYearPowerSaving"  Width="73%"></asp:Label> 万kWh/a

                            </td>
                            <td>年节煤量
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="PerYearCoalSaving"  Width="77%"></asp:Label>
                                tce
