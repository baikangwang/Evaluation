<%@ Page  Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="EquipmentReview.aspx.cs" Inherits="Evaluation.View.Declaration.EquipmentReview" validateRequest="false" %>
        ...
        <div class="tab-content"   id="divfather">
                ...
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0801"   GroupingText="项目基本情况">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="DesignServiceLife"   style="width:87%;margin-left:5%;"></asp:Label> 年
                            </td>
                        </tr>
                        <tr>
                            <td>总建筑面积
                            ...
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="OverallFloorage"   Width="90.9%"></asp:Label>
                                m<sup>2</sup>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_0802"  GroupingText="技术申报内容">
                    <table>
                        <tr>
                            <td style="width:150px;">供暖方式</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingMode"  Width="86%"></asp:Label>
                            </td>
                            <td style="width:150px;">供暖建筑面积</td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td>供暖热负荷</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SpaceHeatingLoad"   Width="85%"></asp:Label>KW
                            </td>
                            <td>供暖热负荷指标</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="SpaceHeatingLoadIndicators"  Width="85%"></asp:Label>W/㎡
                            </td>
                        </tr>
                        <tr>
                            <td>空调系统形式</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConSysMode"  Width="86%"></asp:Label>
                            </td>
                            <td>空调建筑面积</td>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td rowspan="2" colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConCoolingLoad"  Width="86%"></asp:Label>KW
                            </td>
                            <td rowspan="2">空调冷指标</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConCoolingIndicators_TotalArea"  Width="54%"></asp:Label> &nbsp;W/㎡（总建筑面积）
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConCoolingIndicators_AirConArea"  Width="54%"></asp:Label>W/㎡（空调建筑面积）
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2">空调热负荷</td>
                            <td rowspan="2" colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConHeatingLoad"  Width="86%"></asp:Label>KW
                            </td>
                            <td rowspan="2">空调热指标</td>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConHeatingIndicators_TotalArea"  Width="54%"></asp:Label>&nbsp; W/㎡（总建筑面积）
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AirConHeatingIndicators_AirConArea"  Width="54%"></asp:Label>W/㎡（空调建筑面积）
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">冷源</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerType1"  Width="91%"></asp:Label>
                            </td>
                            <td rowspan="3" style="width: 150px;">单台设计制冷量</td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerOutput1"  Width="88%"></asp:Label>
                            </td>
                            <td rowspan="3" style="width: 150px;">台数</td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerQuantity1"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerType2"  Width="91%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerOutput2"  Width="88%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerQuantity2"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerType3"  Width="91%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerOutput3"  Width="88%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="ChillerQuantity3"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">热源</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentType1"  Width="91%"></asp:Label>
                            </td>
                            ...
                            <td rowspan="3">台数</td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentQuantity1"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentType2"  Width="91%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentOutput2"  Width="88%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentQuantity2"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentType3"  Width="91%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentOutput3"  Width="88%"></asp:Label>
                            </td>
                            <td>
                                <asp:Label  runat="server"  ClientIDMode="Static" ID="HeatingEquipmentQuantity3"  Width="89%"></asp:Label>
                            </td>
                        </tr>
                        <tr >
                            <td colspan="6">项目概况
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:TextBox  runat="server"  ClientIDMode="Static" ID="ProjectOverview" TextMode="MultiLine" Style="width: 97%; height: 300px;display:block"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:TextBox  runat="server"  ClientIDMode="Static" ID="TechnologyFeature"  TextMode="MultiLine"   Style="width: 97%; height: 300px;display:block"></asp:TextBox>
                                <script id="TechnologyFeatureTextBox" type="text/plain" style="height: 300px;"></script>
                            </td>
                        </tr>
                        <tr >
                            <td colspan="6">技术成效与深度
                            </td>
                            </tr>
                        <tr>
                            <td colspan="6">
                                <asp:TextBox  runat="server"  ClientIDMode="Static" ID="Effect"  TextMode="MultiLine"  Style="width: 97%; height: 100%;"> </asp:TextBox>
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:TextBox  runat="server"  ClientIDMode="Static" ID="Benefit"  TextMode="MultiLine"  style="width:98%;height:300px;display:block"> </asp:TextBox>
