...
{
    public partial class BIM : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_05_BIM tempBIM =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_05_BIM>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_05_BIM>(tempBIM, divfather);
        ...
        public void SetDropDownList(DropDownList drop, List<Dal.Models.SysConstant> lst)
        {
            if (drop.ClientID == "DesignCategory")
            {
                ...
                drop.DataBind();
                drop.Items.Remove(drop.Items.FindByValue("1403"));
