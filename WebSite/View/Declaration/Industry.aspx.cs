    ...
    public partial class Industry : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_15_Industry tempIndustry =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_15_Industry>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_15_Industry>(tempIndustry, divfather);
