<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="MunicipalReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.MunicipalReview_V2" validateRequest="false"%>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content" id="divfather">
                            ...
                            <td style="padding: 0">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 40%; border-right: none;">
                                            <div >
                                                <asp:Label  runat="server"  ClientIDMode="Static" ID="AcceptanceDepartment"></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                         ...
                         <tr>
                            ...
                            <td style="padding: 0">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 40%;">
                                            <asp:Label runat="server" ID="Qualification" ClientIDMode="Static" Width="85%"></asp:Label>                                          
                                        </td>
                                        <td>证书编号　
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                            <asp:Label runat="server" ID="CertificateNumber" ClientIDMode="Static" Width="85%"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1202" runat="server" ClientIDMode="Static" GroupingText="技术申报内容（市政公用工程）">
                    <table>                     
                         <tr>
                            <td colspan="2" style="text-align: center; padding-left: 10px;">项目规模
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">                               
                                 <asp:TextBox ID="ProjectScale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 97%; height: 500px;"></asp:TextBox>
                                <script id="ProjectScaleTextBox" class="review" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                         <tr>
                            <td style="padding: 10px; width:280px">专业类别
                            </td>
                            <td>
                               <asp:Label ID="ProfessionalCategories" runat="server" ClientIDMode="Static" Width="95%"></asp:Label>
                            </td>
                        </tr>
                        <%--<tr>
                            <td>设计技术及创<br />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label runat="server" ID="Estimate" ClientIDMode="Static" Width="95%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>竣工结算
                            ...
                            <td>
                                <asp:Label runat="server" ID="Settlement" ClientIDMode="Static" Width="95%"></asp:Label>
                            </td>
                        </tr>
                      <%--  <tr>
                            <td>决算与概算的出入原因
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center; padding-left: 10px;">设计主要特点：
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:TextBox ID="MainFeatures" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 97%; height: 500px;"></asp:TextBox>
                                <script id="MainFeaturesTextBox" class="review" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                    </table>
     ...
     <script type="text/javascript">
         ...
         $(function () {
             ...
             InitUEditor('ProjectScaleTextBox', 500);                       // 项目规模
