<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="StandardReview_V2.aspx.cs" Inherits="Evaluation.View.Declaration.StandardReview_V2" validateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .review .edui-default .edui-editor-toolbarboxouter{
         ...
         /*#AwardTextBox,#UnitOpinionTextBox,#RecommendOpinionTextBox{
    ...
    <div class="tabbable">
        ...
        <div class="tab-content"  id="divfather">
            <div class="tab-pane active" id="btab1">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1701"   GroupingText="项目基本情况">
                    <table>
                       <%-- <tr>
                         ...
                         <tr>
                            <td style="width: 150px">图集名称
                            </td>
                            <td>
                                <asp:Label ID="StandardName" runat="server" ClientIDMode="Static" Width="90%"></asp:Label>                                
                            </td>
                            <td style="width: 150px">图集号
                            </td>
                            <td>
                                <asp:Label ID="StandardCode" runat="server" ClientIDMode="Static" Width="93%"></asp:Label>                             
                            </td>
                        </tr>
                        <tr>
                            <td>主编单位
                        ...
                        <tr>
                           ...
                           <%-- <td>
                                <div>
                                    ...
                                    <td>
                                <div>
                                    <asp:Label ID="StartDate"  runat="server" ClientIDMode="Static"></asp:Label><span style="padding:0 0.5em">至</span>                                                               
                                    <asp:Label ID="EndDate"  runat="server" ClientIDMode="Static"></asp:Label>
                                </div>
                            </td>
                            <td>项目来源
                            </td>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel  runat="server"  ClientIDMode="Static" ID="panelPart_1702"   GroupingText="建筑工程标准设计项目特点">
                    <table>
                            <tr>
                            <td style="width: 150px;">图集主要内容
                            </td>
                            <td>
                                ...
                                <script id="PrimaryCoverageTextBox" class ="review cover" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                            <td>图集主要优缺点和效益
                            ...
                            <td>
                                ...
                                <script id="BenefitsTextBox" class ="review cover" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                    </table>
                     <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Award" runat="server" ClientIDMode="Static" TextMode="MultiLine" style="width:97%;height:300px;"></asp:TextBox>
                                                    <script id="AwardTextBox" class ="review opinion " type="text/plain" style="height: 300px;"></script>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="UnitOpinion" runat="server" ClientIDMode="Static" TextMode="MultiLine" style="width:97%;height:300px;"></asp:TextBox>
                                                    <script id="UnitOpinionTextBox" class ="review opinion" type="text/plain" style="height: 300px;"></script>
                                <asp:CheckBox runat="server" ID="IsStandardUnitOpinion" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                <div class="datepicker input-group date">
                                    <asp:Label ID="UnitOpinionDate" runat="server" ClientIDMode="Static" ></asp:Label>
                    ...
                    <script id="RecommendOpinionTextBox" class ="review opinion" type="text/plain" style="height: 300px;"></script>
                     <asp:CheckBox runat="server" ID="IsStandardRecommendOpinion" ClientIDMode="Static" ToolTip="公开" Checked="true" />
                                <div class="datepicker input-group date">
                                    <asp:label ID="RecommendOpinionDate"  runat="server" ClientIDMode="Static"></asp:label>
     ...
     <script type="text/javascript">
         ...
         $(function () {
             ...
             InitUEditor('AwardTextBox', 2000);                                        // 曾获奖项
