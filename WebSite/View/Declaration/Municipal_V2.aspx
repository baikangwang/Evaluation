<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true" CodeBehind="Municipal_V2.aspx.cs" Inherits="Evaluation.View.Declaration.Municipal_V2" validateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        #ProjectScaleTextBox,#MainFeaturesTextBox {
                        ...
                        <tr>
                            ...
                            <td style="padding: 0;">
                                <table class="shejidanwei">
                                    <tr>
                                        <td style="border-top: none;">主要设计单位</td>
                            ...
                            <td style="padding: 0">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 40%; border-right: none;">
                                            <asp:TextBox runat="server" ID="AcceptanceDepartment" ClientIDMode="Static" Width="85%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
...
<%--                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 0">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 40%;">
                                            <asp:TextBox runat="server" ID="Qualification" ClientIDMode="Static" Width="85%"></asp:TextBox>
                                        </td>
                                        <td>证书编号　
                                        </td>
                                        <td style="width: 40%; border-right: none;">
                                            <asp:TextBox runat="server" ID="CertificateNumber" ClientIDMode="Static" Width="85%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1202" runat="server" ClientIDMode="Static" GroupingText="工程勘察设计项目特点">
                    <table>
                        <tr>
                            <td colspan="2" style="text-align: left; padding-left: 10px;">项目规模
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:TextBox ID="ProjectScale" runat="server" ClientIDMode="Static" TextMode="MultiLine" Style="width: 97%; height: 500px;"></asp:TextBox>
                                <script id="ProjectScaleTextBox" type="text/plain" style="height: 300px;"></script>                                
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                               <asp:TextBox ID="ProfessionalCategories" runat="server" ClientIDMode="Static" Width="95%"></asp:TextBox>
                            </td>
                        </tr>
<%--                        <tr>
                            <td>设计技术及创<br />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="Estimate" ClientIDMode="Static" Width="95%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="Settlement" ClientIDMode="Static" Width="95%"></asp:TextBox>
...
<%--                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center; padding-left: 10px;">主要设计特点
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
    ...
    <script type="text/javascript">
        ...
        function onSave(PartCode, Tip) {
            ...
            $("#ProjectScale").val(EncodeUEditorContent(UE.getEditor('ProjectScaleTextBox').getContent()));                                                    // 其他
            ...
            if (
                !checkUEditor('ProjectScaleTextBox')
        ...
        $(function () {
            ...
            InitUEditor('ProjectScaleTextBox', 1000);                       // 项目规模
            InitUEditor('MainFeaturesTextBox', 3600);                      // 设计主要特点
