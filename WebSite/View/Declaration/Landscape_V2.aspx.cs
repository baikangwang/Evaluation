...
{
    public partial class Landscape_V2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dal.Models.Template_13_Landscape tempLandscape =
                    BLL.Declaration.GetDeclarationData<Dal.Models.Template_13_Landscape>(tempInfo.DeclarationID.Value, conn);
                ...
                //为控件赋值
                BLL.Common.SetData<Dal.Models.Template_13_Landscape>(tempLandscape, divfather);
