<%@ Page Language="C#" MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true"  CodeBehind="Survey.aspx.cs" Inherits="Evaluation.View.Declaration.Survey" validateRequest="false"%>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content" runat="server" id="divfather">
            ...
            <div class="tab-pane" id="btab3">
                <asp:Panel ID="panelPart_1402" runat="server" ClientIDMode="Static" GroupingText="技术申报内容">
                    <table>
                        <tr>
