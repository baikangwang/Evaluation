<%@ Page  Title="专家投票" MasterPageFile="~/View/Mutual/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="ExpertVote.aspx.cs" Inherits="Evaluation.View.ExpertElect.ExpertVote" %>
        ...
        function InitTable(PageSize, CuttentPage, Specialtys, PrizeType, PrizeName) {
            ...
            window.operateEvents = {
                'click .Vote': function (e, value, row, index) {
                    window.location = "Ballot.aspx?PrizeID=" + row.PrizeID;
                },
                'click .ReVote': function (e, value, row, index) {
                    window.location = "ExpertRevote.aspx?PrizeID=" + row.PrizeID;
                },
                    ...
                    if (data != "") {                        
                        ...
                        var option = {
                            ...
                            columns: [
                                ...
                                { field: 'VoteDeclarationCount', title: '可投票申报数量', align: 'center', valign: 'middle' },
