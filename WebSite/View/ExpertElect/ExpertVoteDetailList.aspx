<%@ Page Language="C#"  MasterPageFile="~/View/Mutual/Site.Master" AutoEventWireup="true"  CodeBehind="ExpertVoteDetailList.aspx.cs" Inherits="Evaluation.View.ExpertElect.ExpertVoteDetailList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function operateFormatter(value, row, index) {
            return [
             '<a class="ReVoteSet" href="javascript:void(0)" title="查看专家投票">',
             '<i class="fa fa-edit"></i>',
             '</a>  ',
             '<a class="AwardResult" href="javascript:void(0)" title="查看投票结果">',
        ...
        function InitTable(PageSize, CuttentPage, Specialtys, PrizeType, PrizeName) {
            ...
            window.operateEvents = {
                'click .ReVoteSet': function (e, value, row, index) {
                    window.location = "ExpertVoteDetail.aspx?PrizeID=" + row.PrizeID;
                },
                'click .AwardResult': function (e, value, row, index) {
                    window.location = "../ActivityManage/AwardResult.aspx?PrizeID=" + row.PrizeID;
                },
            };
