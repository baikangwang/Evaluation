<%@ Page Language="C#" Title="权限管理" AutoEventWireup="true" CodeBehind="PrivilegeList.aspx.cs" Inherits="Evaluation.View.Privilege.PrivilegeList" MasterPageFile="~/View/Mutual/Site.Master" %>
    ...
    <script>
        ...
        function Permissions(value, row, index) {
            return [
                ...
                '<button type="button" class="control"  >权限详情</button>',
                '</a>  '
            ].join('');
        }
        ...
        function InitTable(PageSize, CuttentPage) {
            ...
            window.operateEvents = {
                ...
                'click .control': function (e, value, row, index) {
                    window.location = "../Privilege/ControlList.aspx?GroupID=" + row.GroupID + "";
                },
